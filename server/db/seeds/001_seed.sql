...
-- Insert Sample Quotations & Line Items for Live Pipeline & Approvals
INSERT INTO quotations (id, company_id, customer_id, sales_rep_id, status, blended_risk_score) VALUES
('44444444-4444-4444-4444-444444444441', '11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333331', '11111111-1111-1111-1111-100000000003', 'pending_approval', 8.50),
('44444444-4444-4444-4444-444444444442', '11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333332', '11111111-1111-1111-1111-100000000003', 'approved', 0.00),
('44444444-4444-4444-4444-444444444443', '11111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-100000000003', 'draft', 0.00);

INSERT INTO quotation_lines (quotation_id, product_id, quantity, unit_price, discount_percent, line_type) VALUES
('44444444-4444-4444-4444-444444444441', '11111111-1111-1111-1111-100000000101', 5, 1200.00, 10.0, 'one_time'),
('44444444-4444-4444-4444-444444444441', '11111111-1111-1111-1111-100000000104', 12, 500.00, 5.0, 'recurring'),
('44444444-4444-4444-4444-444444444442', '11111111-1111-1111-1111-100000000102', 10, 2500.00, 0.0, 'one_time'),
('44444444-4444-4444-4444-444444444443', '11111111-1111-1111-1111-100000000103', 20, 450.00, 0.0, 'one_time');
